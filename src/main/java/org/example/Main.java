...
public class Main {
     ...
     */
    private static double divide(double a, double b) throws CustomDivideByZeroException {
        if (b == 0) {
            throw new CustomDivideByZeroException("Cannot divide " + a + " by 0.", a, b);
        }
        return a / b;
    }
     ...
     * @return The result of the division
     */
    public static double safeDivision(double a, double b) throws ArithmeticException {
     ...
     */
    public static String getSecondLetter(String s, List<String> logMessages) throws StringIndexOutOfBoundsException {
